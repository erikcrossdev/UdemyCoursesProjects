...
public class ProcCube: Object
{
    ...
    static GameObject cube; //new cube to clone, the template

    public static GameObject Clone(Vector4 pos) 
    {
        //Call create cube if the cube is false
        if (cube == null) {
    ...
    {
        cube = new GameObject(); //Create a new gameobject here.
        ...
        cube.GetComponent<MeshFilter>().mesh.name = "Created Cube_" + Time.realtimeSinceStartup.ToString();
